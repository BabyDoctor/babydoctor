            ...
            children: [
              Row(
                children: [
                  ...
                  const Text(
                    '설사', style: TextStyle(color:Color(0xFF455A64),fontWeight: FontWeight.bold, fontSize: 27.0),
                  ),
                ],
              ),
              const SizedBox(
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text("미열",style: TextStyle(color:Colors.black54,fontWeight: FontWeight.bold, fontSize: 17.0),)
                  ],
                ),
              ),
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text('오심',style: TextStyle(color:Colors.black54,fontWeight: FontWeight.bold, fontSize: 17.0),)
                  ],
                ),
              ),
              Padding(
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text("전신무기력",style: TextStyle(color:Colors.black54,fontWeight: FontWeight.bold, fontSize: 17.0),)
                  ],
                ),
              ),
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text('야간 오한',style: TextStyle(color:Colors.black54,fontWeight: FontWeight.bold, fontSize: 17.0),)
                  ],
                ),
              ),
              Padding(
